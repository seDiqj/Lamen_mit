...
const PAGE_URL_TO_NAME: Record<string, string> = {
  ...
  "/financing-data-report": "financing-data-report",
  ...
  const modules: Module[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Collection Entry", url: "/collection-entry", icon: Banknote, iconColor: "text-lime-600" },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Financing Data", url: "/financing-data-report", icon: FileSpreadsheet, iconColor: "text-green-600" },
        { title: "Loan DAB Reports", url: "/dab-reports", icon: FileText, iconColor: "text-purple-500" },
