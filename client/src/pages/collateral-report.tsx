    ...
    <div className="flex flex-col gap-4 p-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold" data-testid="text-page-title">Collateral Report</h1>
            <p className="text-muted-foreground text-sm">View collateral details by branch and date range</p>
          </div>
        </div>
        {data && data.length > 0 && (
